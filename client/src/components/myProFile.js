...
const Myprofile = props => {
    const { first_name, last_name, country, cost, pic, Experience, sum, text, date, email, phone, city, Language, comments,profile_sum } =
...
const Date=(state.endDate.task - state.startDate.task) / (1000 * 60 * 60 * 24)
                    ...
                    <form id="form" >
                        <div className="form-Top" >
                            <div class="col-md-6 mb-3" >
                                ...
                                <input value={startDate.task} onChange={startDatechangeHandler} id="StartDate" placeholder="" type="date" class="form-control" required />

                            </div>
                            <div className="col-md-6 mb-2">
                                <label for="validationTooltip02">End Date</label>
                                <input value={endDate.task} onChange={endDatechangeHandler} id="EndDate" type="date" class="form-control" required />
                        ...
                        <div className="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="Tourists" id="Tourists" placeholder="">
                                    <option type="number" value="one">1</option>
                                    <option type="number" value="two">2</option>
                                    <option type="number" value="tree">3</option>
                                    <option type="number" value="four">4</option>
                                    <option type="number" value="five">5</option>
                                    <option type="number" value="six">6</option>
                                    <option type="number" value="seven">7+</option>
                                </select>
